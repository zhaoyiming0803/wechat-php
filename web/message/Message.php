  ...
  class Message extends Wx {
    ...
    private function event () {
      if (self::$msg->Event == 'subscribe') {
        $content = '感谢您的订阅，当前公众号正在开发中（https://github.com/zymseo/wx-public），有问题请直接加我微信：zhao-seo，';
        ...
        $content = '欢迎来到我的测试公众号，当前公众号正在开发中（https://github.com/zymseo/wx-public）,有问题可以加我微信：zhao-seo';
      }
      $this->text($content);
    }
